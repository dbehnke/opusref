...
cc -std=c11 -Wall -Wextra -Werror $opus_cflags generate_fec.c $opus_libs -o "$fixture_tmp/generate_fec"
"$fixture_tmp/generate_fec" fec-context-20ms.hex fec-prior-20ms.hex fec-recovery-20ms.hex
# shellcheck disable=SC2086
