...
ffmpeg -y -loglevel error -f lavfi -i 'sine=frequency=700:sample_rate=48000:duration=0.06' -ac 1 -c:a libopus -application voip -frame_duration 20 -vbr off -b:a 16k -fec 1 -packet_loss 10 "$fixture_tmp/fec-20ms.ogg"
...
extract_packet "$fixture_tmp/fec-20ms.ogg" 1 fec-prior-20ms.hex
extract_packet "$fixture_tmp/fec-20ms.ogg" 2 fec-recovery-20ms.hex
...
"$fixture_tmp/verify_fec" fec-prior-20ms.hex fec-recovery-20ms.hex
